...
if(mysqli_num_rows($result) > 0){
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		echo "<tr>
		<td><a href='tugas3editdt.php?key=$row[NIK]'>ubah</a></td>
		&emsp;|&emsp;
...
// To go next page
echo"<br><br><form action='tugas3tmbhdt.php'><input type='submit' name='btnTambah' value='Tambah Data'></form>";
